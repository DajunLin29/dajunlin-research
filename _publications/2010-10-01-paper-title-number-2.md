---
title: "Inverse-designed multi-level diffractive doublet for wide field-of-view imaging"
...
excerpt: |
  ...
  <br>
  <img src="/dajunlin-research/images/fig1.png" alt="WFOV camera result" width="600">
  <br>
...
![WFOV camera result]({{ site.baseurl }}/images/fig1.png)
<br clear="all">
...
![WFOV camera result]({{ site.baseurl }}/images/fig3.png)
<br clear="all">
Fabrication and assembly of the MDL doublet. (a) Top-view optical micrograph. (b) 3D scanning-confocal micrograph and (c) radial cross-section through the center of MDL1. Corresponding results for MDL2 are in (d−f), respectively. (g) Optical micrograph of the MDL doublet after assembly. (h) Schematic of the process used to align the two MDLs. (i) Side view of the details of the MDL doublet. The air gap between the
MDLs was set by a precision shim.

![WFOV camera result]({{ site.baseurl }}/images/fig5.png)
<br clear="all">
